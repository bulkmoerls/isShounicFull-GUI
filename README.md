...
## "Where's the Original ISF then?"

The original ISF is coded using [Python](https://www.python.org), and I still have the original file. If you want, I can post it on GitHub right now. Anyways...

## Programming Language

ISF-GUI originally uses [Rust](https://rust-lang.org/) as the programming language as it is robust and fast, but I find it harder to learn since I am still working on learning the basics of code, so I currently use [Go](https://go.dev) for now.
...
gotk3 for the same thing and borrowing code from example repo.
